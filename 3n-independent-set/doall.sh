...
scripts/gen-input-via-stdout.sh "wine files/gen_triple.exe 1" "tests/03" 3
echo "Generating test #6"
scripts/gen-input-via-stdout.sh "wine files/gen_triple.exe 2" "tests/06" 6
echo "Generating test #7"
scripts/gen-input-via-stdout.sh "wine files/gen_triple.exe 3" "tests/07" 7
echo "Generating test #8"
scripts/gen-input-via-stdout.sh "wine files/bad_gen.exe 1" "tests/08" 8
echo "Generating test #9"
scripts/gen-input-via-stdout.sh "wine files/bad_gen.exe 4" "tests/09" 9
echo "Generating test #10"
scripts/gen-input-via-stdout.sh "wine files/bad_gen.exe 8" "tests/10" 10
echo "Generating test #11"
scripts/gen-input-via-stdout.sh "wine files/bad_gen.exe 9" "tests/11" 11
echo "Generating test #12"
scripts/gen-input-via-stdout.sh "wine files/bad_gen.exe 10" "tests/12" 12
echo "Generating test #13"
scripts/gen-input-via-stdout.sh "wine files/cicle_gen.exe 3" "tests/13" 13
echo "Generating test #14"
scripts/gen-input-via-stdout.sh "wine files/gen_ezh.exe 5" "tests/14" 14
echo "Generating test #15"
scripts/gen-input-via-stdout.sh "wine files/gen_ezh.exe 6" "tests/15" 15
echo "Generating test #16"
scripts/gen-input-via-stdout.sh "wine files/gen_wa_for_multiple_dec.exe 1" "tests/16" 16
echo "Generating test #17"
scripts/gen-input-via-stdout.sh "wine files/gen_wa_for_multiple_dec.exe 2" "tests/17" 17
echo "Generating test #18"
scripts/gen-input-via-stdout.sh "wine files/gen_wa_for_multiple_dec.exe 3" "tests/18" 18
echo "Generating test #19"
scripts/gen-input-via-stdout.sh "wine files/gen_wa_for_multiple_dec.exe 10" "tests/19" 19
echo "Generating test #20"
scripts/gen-input-via-stdout.sh "wine files/gen_wa_for_multiple_dec.exe 50" "tests/20" 20
echo "Generating test #21"
scripts/gen-input-via-stdout.sh "wine files/gen_wa_for_multiple_dec.exe 100" "tests/21" 21
echo "Generating test #22"
scripts/gen-input-via-stdout.sh "wine files/gen_wa_for_multiple_dec.exe 150" "tests/22" 22
echo "Generating test #23"
scripts/gen-input-via-stdout.sh "wine files/gen_wa_for_multiple_dec.exe 182" "tests/23" 23
echo "Generating test #24"
scripts/gen-input-via-stdout.sh "wine files/gen_ezh.exe 5000" "tests/24" 24
echo "Generating test #25"
scripts/gen-input-via-stdout.sh "wine files/gen_ezh.exe 30000" "tests/25" 25
echo "Generating test #26"
scripts/gen-input-via-stdout.sh "wine files/gen_ezh.exe 50000" "tests/26" 26
echo "Generating test #27"
scripts/gen-input-via-stdout.sh "wine files/gen_ezh.exe 75000" "tests/27" 27
echo "Generating test #28"
scripts/gen-input-via-stdout.sh "wine files/gen_ezh.exe 99999" "tests/28" 28
echo "Generating test #29"
scripts/gen-input-via-stdout.sh "wine files/gen_ezh.exe 100000" "tests/29" 29
echo "Generating test #30"
scripts/gen-input-via-stdout.sh "wine files/cicle_gen.exe 100000" "tests/30" 30
echo "Generating test #31"
scripts/gen-input-via-stdout.sh "wine files/cicle_gen.exe 99999" "tests/31" 31
echo "Generating test #32"
scripts/gen-input-via-stdout.sh "wine files/cicle_gen.exe 81239" "tests/32" 32
echo "Generating test #33"
scripts/gen-input-via-stdout.sh "wine files/cicle_gen.exe 98394" "tests/33" 33
echo "Generating test #34"
scripts/gen-input-via-stdout.sh "wine files/gen_triple.exe 10000" "tests/34" 34
echo "Generating test #35"
scripts/gen-input-via-stdout.sh "wine files/gen_triple.exe 25000" "tests/35" 35
echo "Generating test #36"
scripts/gen-input-via-stdout.sh "wine files/gen_triple.exe 100000" "tests/36" 36
echo "Generating test #37"
scripts/gen-input-via-stdout.sh "wine files/gen_triple.exe 99999" "tests/37" 37
echo "Generating test #38"
scripts/gen-input-via-stdout.sh "wine files/gen_triple.exe 98304" "tests/38" 38
echo "Generating test #39"
scripts/gen-input-via-stdout.sh "wine files/bad_gen.exe 25000" "tests/39" 39
echo "Generating test #40"
scripts/gen-input-via-stdout.sh "wine files/bad_gen.exe 39000" "tests/40" 40
echo "Generating test #41"
scripts/gen-input-via-stdout.sh "wine files/bad_gen.exe 98304" "tests/41" 41
echo "Generating test #42"
scripts/gen-input-via-stdout.sh "wine files/bad_gen.exe 100000" "tests/42" 42
echo "Generating test #43"
scripts/gen-input-via-stdout.sh "wine files/bad_gen.exe 99999" "tests/43" 43
echo "Generating test #44"
scripts/gen-input-via-stdout.sh "wine files/one_graph_gen.exe 7541" "tests/44" 44
echo "Generating test #45"
scripts/gen-input-via-stdout.sh "wine files/one_graph_gen.exe 10000" "tests/45" 45
echo "Generating test #46"
scripts/gen-input-via-stdout.sh "wine files/one_graph_gen.exe 15000" "tests/46" 46
echo "Generating test #47"
scripts/gen-input-via-stdout.sh "wine files/one_graph_gen.exe 50000" "tests/47" 47
echo "Generating test #48"
scripts/gen-input-via-stdout.sh "wine files/one_graph_gen.exe 100000" "tests/48" 48
echo "Generating test #49"
scripts/gen-input-via-stdout.sh "wine files/one_graph_gen.exe 99999" "tests/49" 49
echo "Generating test #50"
scripts/gen-input-via-stdout.sh "wine files/one_graph_gen.exe 83819" "tests/50" 50
echo "Generating test #51"
scripts/gen-input-via-stdout.sh "wine files/triple_ezh_gen.exe 86000" "tests/51" 51
echo "Generating test #52"
scripts/gen-input-via-stdout.sh "wine files/triple_ezh_gen.exe 50000" "tests/52" 52
echo "Generating test #53"
scripts/gen-input-via-stdout.sh "wine files/double_ezh_gen.exe 99999" "tests/53" 53
echo "Generating test #54"
scripts/gen-input-via-stdout.sh "wine files/triple_ezh_gen.exe 100000" "tests/54" 54
echo "Generating test #55"
scripts/gen-input-via-stdout.sh "wine files/double_ezh_gen.exe 75000" "tests/55" 55
echo "Generating test #56"
scripts/gen-input-via-stdout.sh "wine files/triple_ezh_gen.exe 99999" "tests/56" 56
echo "Generating test #57"
scripts/gen-input-via-stdout.sh "wine files/double_ezh_gen.exe 100000" "tests/57" 57
echo ""
